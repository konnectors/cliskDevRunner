...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var post_me__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
class LauncherBridge extends Bridge {
  /**
  ...
  async init({ exposedMethods = {} } = {}) {
    ...
    this.connection = await (0,post_me__WEBPACK_IMPORTED_MODULE_0__.ChildHandshake)(messenger, exposedMethods)
...
class ReactNativeWebviewMessenger extends MessengerInterface {
  /**
...
async function main() {
  ...
  const response = await bridge.call('ping')
  console.log('✅✅✅ ping called', response)
  await bridge.emit('test-event', { message: 'test event coucou' })
